		...
		<?php if ( ! post_password_required() ) : ?>
					...
					<?php if ( has_category() ) : ?>
							<span class="category-icon">
								<?php the_category( _x( ', ', 'Used between list items, there is a space after the comma.', 'fbachflowers' ) ) ?>
							</span><!-- .category-icon -->						
					<?php endif; ?>
				
					<?php if ( has_tag() ) : ?>
							<span class="tags-icon">
								<?php the_tags( '', _x( ', ', 'Used between list items, there is a space after the comma.', 'fbachflowers' ), '' ); ?>
							</span><!-- .tags-icon -->						
					<?php endif; ?>
