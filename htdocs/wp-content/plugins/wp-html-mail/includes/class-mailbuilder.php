                    ...
                    foreach ( $mailbuilder_array as $element_content ):
                        if( isset( $element_content['settings'] ) && isset( $element_content['settings']['styles'] ) ){
                            foreach ( $element_content['settings']['styles']['desktop'] as $attribute => $value ) {
                                if( $value ){
                                    if( stripos( $attribute, 'padding' ) !== false )
                                        $desktop_styles .= ' #' . $element_content['id'] . ' .container-padding{ ' . $attribute . ': ' . $value . '; } ';
                                    else
                                        $desktop_styles .= ' #' . $element_content['id'] . '{ ' . $attribute . ': ' . $value . '; } ';
                                }
                            }
                            ...
                            foreach ( $element_content['settings']['styles']['mobile'] as $attribute => $value ) {
                                if( $value ){
                                    if( stripos( $attribute, 'padding' ) !== false )
                                        $mobile_styles .= ' table#' . $element_content['id'] . '[id="' . $element_content['id'] . '"] td[class*="container-padding"]{ ' . $attribute . ': ' . $value . '; } ';
                                    else
                                        $mobile_styles .= ' table#' . $element_content['id'] . '[id="' . $element_content['id'] . '"] { ' . $attribute . ': ' . $value . '; } ';
                                }
                            }
                        }
