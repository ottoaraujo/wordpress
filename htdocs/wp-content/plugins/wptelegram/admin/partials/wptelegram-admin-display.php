...
(function ($) {
    ...
    $(document).ready(function() {
        ...
        var inline_button = $('input[type="checkbox"][name="wptelegram_message[inline_url_button]"]');
        ...
        inline_button.change(function() {
            var $this = $(this);
            var elem = $this.closest('tr').siblings('.inline_button_text');
            if ($this.is(':checked')) {
                elem.show();
            } else {
                elem.hide();
